...
{
    [TestClass]
    public class MunqServiceLocatorIntegrationTests : AbstractServiceLocatorTest
    {
        ...
        [TestMethod, TestCategory("ServiceLocator: Munq"), ExpectedException(typeof(ServiceLocatorResolutionException))]
