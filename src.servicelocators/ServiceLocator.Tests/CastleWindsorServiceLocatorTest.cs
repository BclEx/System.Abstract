...
namespace System.Abstract.Tests.ServiceLocator.Integration
{
    ...
    public class CastleWindsorServiceLocatorIntegrationTests : AbstractServiceLocatorTest
    {
        ...
        [TestMethod, TestCategory("ServiceLocator: CastleWindsor")]
        ...
        [TestMethod, TestCategory("ServiceLocator: CastleWindsor"), ExpectedException(typeof(ServiceLocatorResolutionException))]
