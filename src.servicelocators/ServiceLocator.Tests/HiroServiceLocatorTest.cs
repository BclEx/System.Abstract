...
{
    [TestClass]
    public class HiroServiceLocatorIntegrationTests : AbstractServiceLocatorTest
    {
        protected override IServiceLocator CreateServiceLocator() { return new HiroServiceLocator(); }

        [TestMethod, TestCategory("ServiceLocator: Hiro")]
        ...
        [TestMethod, TestCategory("ServiceLocator: Hiro"), ExpectedException(typeof(ServiceLocatorResolutionException))]
