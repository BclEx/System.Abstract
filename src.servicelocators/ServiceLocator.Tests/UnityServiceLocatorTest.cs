...
{
    [TestClass]
    public class UnityServiceLocatorIntegrationTests : AbstractServiceLocatorTest
    {
        protected override IServiceLocator CreateServiceLocator() { return new UnityServiceLocator(); }

        [TestMethod, TestCategory("ServiceLocator: Unity")]
        ...
        [TestMethod, TestCategory("ServiceLocator: Unity"), ExpectedException(typeof(ServiceLocatorResolutionException))]
