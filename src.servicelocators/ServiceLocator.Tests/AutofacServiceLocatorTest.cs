...
{
    [TestClass]
    public class AutofacServiceLocatorIntegrationTests : AbstractServiceLocatorTest
    {
        ...
        [TestMethod, TestCategory("ServiceLocator: Autofac"), ExpectedException(typeof(ServiceLocatorResolutionException))]
