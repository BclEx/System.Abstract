...
namespace System.Abstract.Tests.ServiceLocator.Integration
{
    ...
    public class SpringServiceLocatorIntegrationTests : AbstractServiceLocatorTest
    {
        ...
        [TestMethod, TestCategory("ServiceLocator: Spring"), ExpectedException(typeof(ServiceLocatorResolutionException))]
